...
var ItemService = /** @class */ (function () {
    ...
    ItemService.prototype.getItems = function (startObj, endObj) {
        this.itemsCollection = this.afs.collection('tvdb', function (ref) { return ref.orderBy('tvname').startAt(startObj).endAt(endObj + '\uf8ff'); });
